...
//	}
	...
	@Test(dataProvider = "trainData")
	public void searchTrains(String source, String destination) throws InterruptedException {
		// Test method to search for trains
		
		Reporter.log("Searching for trains from " + source + " to " + destination);
		irctcHomePage.chooseTrain(source, destination);
		
		
		Reporter.log("Train search completed successfully.");
	}
